...
urlpatterns = [
    ...
    path("compras/categorias/", views.CategoriaCompraListView.as_view(), name="categoria_compra_lista"),
    path("compras/categorias/nueva/", views.CategoriaCompraCreateView.as_view(), name="categoria_compra_crear"),
    path("compras/categorias/<int:pk>/editar/", views.CategoriaCompraUpdateView.as_view(), name="categoria_compra_editar"),
