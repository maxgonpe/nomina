...
Siguiente tarea: REN004 — Documentos y respaldos (Bloque 2).
Django es la fuente oficial. Reutilizar DocumentoRendicion.
UI en español (Chile). Bloque 1 y REN001–REN003 cerrados — no rehacerlos.
...
python manage.py test rendiciones                # 33 OK al cerrar REN003
```
...
**Cerrado:** infra + **Bloque 1** + **REN001–REN003**.  
**Siguiente:** **REN004 — Documentos y respaldos**.
...
| REN004 | Documentos / respaldos | **Siguiente** |
